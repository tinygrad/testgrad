...
from testgrad.helpers import prod, to_mv, getenv, round_up, cache_dir, T, init_c_struct_t, PROFILE
from testgrad.device import Compiled, Compiler, CompileError, LRUAllocator, cpu_profile, ProfileDeviceEvent, ProfileRangeEvent
from testgrad.renderer.cstyle import MetalRenderer
...
class MetalDevice(Compiled):
  def __init__(self, device:str):
    ...
    from testgrad.runtime.graph.metal import MetalGraph
...
class MetalCompiler(Compiler):
  ...
  with contextlib.suppress(FileNotFoundError, ModuleNotFoundError):
    import testgrad.runtime.autogen.llvm # noqa: F401
