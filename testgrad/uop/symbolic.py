...
from testgrad.uop.ops import Ops, PatternMatcher, UPat, UOp, GroupOp, exec_alu
from testgrad.dtype import ConstType, dtypes, PtrDType
from testgrad.helpers import partition, all_same, prod, flatten, get_single_element, cdiv, cmod, CORRECT_DIVMOD_FOLDING
from testgrad.uop.transcendental import xpow
...
sym = symbolic_flat+PatternMatcher([
  ...
  # any CONST feeding REDUCE (in not first source) is removed
