...
from testgrad import Tensor, nn, getenv, GlobalCounters, Variable
from testgrad.nn.datasets import mnist
from testgrad.helpers import trange

class Model:
  def __init__(self):
    self.layers: List[Callable[[Tensor], Tensor]] = [
      nn.Conv2d(1, 32, 3), Tensor.relu, Tensor.max_pool2d,
      nn.Conv2d(32, 32, 3), Tensor.relu, Tensor.max_pool2d,
      lambda x: x.flatten(1), nn.Linear(800, 10)]
